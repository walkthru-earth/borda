...
<style>
	...
	@media(max-width:600px){.crumbs{font-size:.875rem;margin-bottom:18px}.hero{grid-template-columns:1fr;padding:19px;gap:22px}.media{max-height:270px;aspect-ratio:1.25}.price-summary{display:flex;grid-column:auto;padding:19px}.info h1{font-size:1.5625rem}.section-panel{padding:19px;margin-bottom:18px}.detail-columns{gap:0}.seller-row{grid-template-columns:minmax(0,1fr) auto;gap:12px;padding:14px}.visit{grid-column:1/-1;justify-content:center;padding:9px}.specs{grid-template-columns:1fr 1fr;gap:0 18px}.related .section-heading{align-items:start}.related .doc-link{font-size:.8125rem}.notice{align-items:start;flex-direction:column}.headline-price{font-size:1.9375rem}}
