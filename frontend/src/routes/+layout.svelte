<script lang="ts">
 ...
 $effect(() => { document.documentElement.lang = locale.language; document.documentElement.dir = locale.language === 'ar' ? 'rtl' : 'ltr'; setAnalyticsLanguage(locale.language); });
 $effect(() => { if (catalog.error) trackCatalogError(catalog.error); });
...
<footer class="container footer">
 ...
 <nav class="foot-links" aria-label={tr('Project links','روابط المشروع')}><a class="foot-brand" href="https://walkthru.earth" target="_blank" rel="noopener"><img src="{base}/brand/walkthru-earth-logo.svg" alt="Walkthru.Earth" /></a><span aria-hidden="true">·</span><a href="https://github.com/walkthru-earth/borda/blob/main/LICENSE" target="_blank" rel="noopener">{tr('CC BY 4.0 license','رخصة CC BY 4.0')}</a></nav>
...
<style>
 .language-switch { display:flex; align-items:center; gap:7px; font-size:.9375rem; white-space:nowrap; font-weight:600; color:var(--accent); }
 .skip { position:fixed; top:-80px; left:16px; z-index:100; padding:12px; background:var(--surface); }.skip:focus { top:8px; }
 .top { position:sticky; top:0; z-index:30; background:#fffffff5; backdrop-filter:blur(12px); border-bottom:1px solid var(--line); }.bar { display:flex; align-items:center; gap:26px; min-height:86px; }.brand { display:flex; align-items:center; gap:10px; font-size:1.25rem; letter-spacing:-.6px; font-weight:750; flex-shrink:0; line-height:1.15; }.brand-sub { display:block; color:var(--muted); font-size:.75rem; letter-spacing:2.1px; font-weight:600; margin-top:5px; }.brand-mark { border-radius:12px; }.wordmark { font-size:1.8125rem; font-weight:750; letter-spacing:-1.2px; }.wordmark .brand-sub { font-size:.6875rem; letter-spacing:1px; }.search { flex:1; display:flex; align-items:center; gap:12px; background:var(--bg); border:1px solid var(--line); border-radius:11px; padding:0 15px; height:45px; color:var(--muted); }.search:focus-within { border-color:var(--accent); box-shadow:0 0 0 3px var(--accent-soft); }.search input { width:100%; min-width:0; border:0; outline:0; background:transparent; color:var(--fg); font-size:1rem; }.search input::-webkit-search-cancel-button { -webkit-appearance:none; }.search button { display:grid; place-items:center; min-width:28px; min-height:32px; }kbd { border:1px solid var(--line); background:white; padding:0 6px; border-radius:4px; }.source { display:flex; align-items:center; gap:8px; font-size:.9375rem; font-weight:600; white-space:nowrap; }main { padding:30px 0 48px; min-height:75vh; }.footer { border-top:1px solid var(--line); display:grid; grid-template-columns:minmax(0,1fr) auto minmax(0,1fr); align-items:center; gap:24px; padding:22px 0 calc(24px + var(--safe-b)); font-size:.9375rem; color:var(--muted); }.footer strong { color:var(--fg); font-size:1.0625rem; }.foot-meta { display:flex; flex-direction:column; gap:4px; text-align:end; justify-self:end; max-width:330px; }.foot-links { display:flex; align-items:center; gap:7px; justify-content:center; white-space:nowrap; }.foot-links a { color:var(--accent); text-decoration:underline; text-decoration-color:transparent; text-underline-offset:3px; }.foot-links a:hover, .foot-links a:focus-visible { text-decoration-color:currentColor; }.foot-brand { display:flex; align-items:center; }.foot-brand img { width:auto; height:20px; max-width:170px; display:block; }.foot-links a:hover, .foot-links a:focus-visible { text-decoration-color:currentColor; }.notice { padding:16px; display:flex; justify-content:space-between; align-items:center; margin-bottom:20px; border-color:#e5bba6; }
 @media(max-width:1000px) { .bar { gap:24px; }.source span { display:none; } }
 @media(max-width:700px) { .bar { gap:12px; padding:16px 0; flex-wrap:wrap; }.brand { font-size:1.125rem; }.wordmark .brand-sub { font-size:.5625rem; letter-spacing:.3px; }.language-switch { font-size:.875rem; }.source { margin-inline-start:auto; }.search { order:3; flex-basis:100%; }.bar { min-height:0; }.footer { display:flex; flex-direction:column; align-items:stretch; }.foot-links { order:2; }.foot-meta { order:3; text-align:start; align-self:stretch; max-width:none; }main { padding-top:20px; } }
</style>
